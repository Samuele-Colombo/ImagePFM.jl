...
test_matrix     = RGB{Float32}[RGB(1.0f1, 2.0f1, 3.0f1) RGB(1.0f2, 2.0f2, 3.0f2)
                               RGB(4.0f1, 5.0f1, 6.0f1) RGB(4.0f2, 5.0f2, 6.0f2)
                               RGB(7.0f1, 8.0f1, 9.0f1) RGB(7.0f2, 8.0f2, 9.0f2)]
test_matrix_err = RGB{Float64}[RGB(1.0e1, 2.0e1, 3.0e1) RGB(1.0e2, 2.0e2, 3.0e2)
...
# test throw RGB eltype error
@testset "throw RGB eltype error" begin
    img = test_matrix_err
    io = IOBuffer()
    @test_throws InvalidRGBEltype ImagePFM.write(io, format"PFM", img)
end
